...
<body class="bg-light">
	<div class="container">
		<div class="py-5 text-center">
			...
			<h2 align="left">Cadastro de Usuários</h2>
		</div>
	</div>
		...
		<form class="needs-validation" novalidate action="" method="post">
			...
			<div class="mb-3">
				<label for="password">Senha</label> <input type="text"
					class="form-control" id="pass" placeholder="Informe sua senha"
					value="" required>
				<div class="invalid-feedback">Valid first password is
					required.</div>
			</div>

			<div class="mb-3">
				<label for="firstName">Nome Completo</label> <input type="text"
					class="form-control" id="nome"
					placeholder="Informe seu nome completo" value="" required>
	...
	<footer class="my-5 pt-5 text-muted text-center text-small">
		<!-- p class="mb-1" align="left">&copy; 2020.1</p -->
	</footer>
