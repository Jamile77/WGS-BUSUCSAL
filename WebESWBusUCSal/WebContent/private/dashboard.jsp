...
<link rel="canonical"
	href="https://getbootstrap.com/docs/4.4/examples/dashboard/">
...
<jsp:useBean id="usuario" class="br.ucsal.busucsal.model.Usuario"
...
<body>
	<nav
		...
		<a class="navbar-brand col-sm-3 col-md-2 mr-0"
			href="../private/dashboard.jsp">BusUCSal</a>
		<div class="usuario">
				...
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link"
							href="./usuario_cad.jsp"> <span data-feather="file"></span>
								Usuários
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"> <span
								data-feather="file"></span> Roteiros
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"> <span
								data-feather="shopping-cart"></span> Avisos
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#"> <span
								data-feather="users"></span> Eventos
						</a></li>
					</ul>
				</div>
			</nav>
